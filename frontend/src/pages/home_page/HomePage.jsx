      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed">
            Join thousands of members who have achieved their fitness goals with our expert trainers and state-of-the-art equipment.
          </p>
  ...
  return (
    <section className="section bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2>Why Choose FitFat?</h2>
          <p>Experience the difference with our world-class facilities and personalized approach to fitness.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              At FitFat Gym, we believe that fitness is not just about physical transformation, 
              but about building confidence, discipline, and a healthier lifestyle. Our community 
              of dedicated members and expert trainers creates an environment where everyone can thrive.
            </p>
  ...
  const testimonials = [
    {
      ...
      content: "FitFat Gym transformed my life! The trainers are incredible and the community is so supportive. I've never felt stronger or more confident.",
      rating: 5
    },
    {
      name: "Mike Chen",
      ...
      content: "The best gym in the city! Clean facilities, great equipment, and amazing trainers. I've been a member for 3 years and love every workout.",
      rating: 5
    },
    {
      ...
      content: "I was intimidated by gyms before joining FitFat. The staff made me feel comfortable and helped me achieve goals I never thought possible.",
      rating: 5
    }
  ];
    ...
    <section className="section bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p>Real stories from real people who have transformed their lives at FitFat Gym.</p>
        </motion.div>
      ...
      <div className="container mx-auto px-4 text-center text-white">
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join thousands of members who have transformed their lives. Your new self is just one step away.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup" className="bg-white text-secondary-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-colors duration-200">
              Get Started Today
            </Link>
            <Link to="/contact" className="border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-secondary-600 transition-colors duration-200">
              Contact Us
            </Link>
          </div>
        </motion.div>
