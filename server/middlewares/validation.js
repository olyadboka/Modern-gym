...
export const validateSchedule = [
  ...
  body('category')
    .isIn(['Yoga', 'Pilates', 'HIIT', 'Strength Training', 'Cardio', 'Dance', 'Martial Arts', 'Swimming'])
...
export const validateService = [
  ...
  body('category')
    .isIn(['Personal Training', 'Group Classes', 'Cardio Training', 'Strength Training', 'HIIT & CrossFit', 'Flexibility & Recovery'])
    .withMessage('Valid category is required'),
